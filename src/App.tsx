...
import { Occurrence, User, Status, Area, Role, AppNotification } from './types';
import { auth, db } from './firebase/config';
import { onAuthStateChanged } from 'firebase/auth';
import type { User as FirebaseUser } from 'firebase/auth';
// Fix: Added deleteDoc to firestore imports to solve undefined name error in TrashPanel handler
import { 
  collection, 
  onSnapshot, 
  doc, 
